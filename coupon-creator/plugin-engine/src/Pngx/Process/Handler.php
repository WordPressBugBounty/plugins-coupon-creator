...
/**
 * Class Pngx__Process__Handler
 *
 * The base class for all Modern Pngx async process handlers.
 *
 * @since 4.7.12
...
abstract class Pngx__Process__Handler {
	...
	/**
	 * Pngx__Process__Handler constructor.
	 *
	 * @since 4.7.12
	 */
	public function __construct() {
		 ...
		 */
		$allow_nopriv = apply_filters( 'pngx_process_allow_nopriv_handling', true, $this );
	...
	public function dispatch() {
		if (
			...
			do_action( 'pngx_log', 'debug', $this->identifier, [ 'action' => 'sync_handle', 'data' => $this->data ] );
		...
		if ( $this->feature_detection->supports_async_process() ) {
			...
			do_action( 'pngx_log', 'debug', $this->identifier, [ 'action' => 'async_dispatch', 'data' => $this->data ] );
