...
class Pngx__Process__Tester extends Pngx__Process__Handler {
	 ...
	 * @var
	 */
	const TRANSIENT_NAME = 'pngx_supports_async_process';
	...
	/**
	 * An override of the method implemented by the base Pngx Handler
