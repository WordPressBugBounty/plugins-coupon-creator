...
( function( $, obj, _ ) {
	...
	obj.selector = {
		dropdown: '.pngx-dropdown',
		created: '.pngx-dropdown-created',
		searchField: '.select2-search__field',
	};

	// Setup a Dependent
	$.fn.pngx_dropdowns = function() {
		obj.dropdown( this, {} );
	...
	obj.ajaxurl = function() {
		...
		if ( 'undefined' !== typeof pngx_admin && 'undefined' !== typeof pngx_admin.ajaxurl ) {
			return pngx_admin.ajaxurl;
		}
