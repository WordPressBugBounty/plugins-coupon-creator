...
class Cctor__Coupon__Admin__Field__Pro_Heading {
	...
	public static function display( $field = array(), $options = array(), $options_id = null, $meta = null ) {
		...
		if ( ! defined( 'CCTOR_HIDE_UPGRADE' ) || ! CCTOR_HIDE_UPGRADE ) {
			...
			echo '<div class="pro-heading"><img style="width: 180px; height: auto;" alt="' . esc_attr__( 'Coupons that expire on their own with Coupon Creator Pro.', 'coupon-creator' ) . '" src="' . esc_url( pngx( 'cctor' )->resource_url ) . 'images/cctor-logo.png"/></div>';
		}
